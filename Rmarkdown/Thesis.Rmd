...
9.  [Probabilistic cell-type assignment of single-cell RNA-seq for tumor
    microenvironment
...
12. [An Introduction to Diffusion
    Maps](https://inside.mines.edu/~whereman/talks/delaPorte-Herbst-Hereman-vanderWalt-DiffusionMaps-PRASA2008.pdf){.uri}.

13. [pydiffmap Diffusion Maps
    Theory](https://pydiffmap.readthedocs.io/en/master/theory.html){.uri}

14. [CytoSPADE: high-performance analysis and visualization of
    high-dimensional cytometry
    data](https://academic.oup.com/bioinformatics/article/28/18/2400/251629){.uri}

15. [A comparison of single-cell trajectory inference
    methods](https://www.nature.com/articles/s41587-019-0071-9.pdf){.uri}

16. [PAGA: graph abstraction reconciles clustering with trajectory
...
17. [Guidelines for the use of flow cytometry and cell sorting in
    immunological
    studies\*](https://onlinelibrary.wiley.com/doi/10.1002/eji.201646632){.uri}

18. [Implementation and Validation of an Automated Flow Cytometry
    Analysis Pipeline for Human Immune
    Profiling](https://onlinelibrary.wiley.com/doi/10.1002/cyto.a.23664){.uri}

19. [Elucidation of seventeen human peripheral blood B-cell subsets and
    ...
    data](https://onlinelibrary.wiley.com/doi/10.1002/cyto.b.20554){.uri}
...
-   Calculating the 3rd diffusion component now
    ...
    -   Should do the same thing for the diseased cohort? -- Not if
        going to run all samples together soon
...
-   It doesn't look like I need to run tsne as it is just for
    vizualization, though run_wishbone does require the diffusion
...
wishbone_object.diffusion_eigenvectors =
pd.DataFrame(scanpy_ad.obms['X_diffmap'])

wishbone_object.diffusion_eigenvalues =
pd.DataFrame(scanpy_ad.uns['diffmap_evals'])
...
-   tSNE is a popular visualization for trajectory inference as it
    ...
    -   ![](images/paste-D25B15BE.png){width="382"}

    -   ![](images/paste-14BF8F43.png){width="381"}

    -   ![](images/paste-0CA5A92C.png){width="384"}
...
-   ![](images/paste-D2936FEB.png){width="433"}
